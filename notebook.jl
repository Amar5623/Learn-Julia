...
# ╔═╡ feeef6e5-4bf5-4732-a94f-a9faef7efb90
begin
	using DataFrames
	using CSV
end

# ╔═╡ 426ff505-141d-41e5-900e-e60fe3414c02
using Plots  # This will install plots

# ╔═╡ ea79d1a4-82d6-42f1-88de-87e3f5aa7730
using PlutoUI

# ╔═╡ e85a604e-0ab8-45c9-b918-1f50de7f85d7
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 30796661-e3c1-4fb3-a0aa-6a0fb0063f36
df.Country_code === df[!, "Country_code"]

# ╔═╡ 7a48450d-e8b7-48a9-b47b-3b76c48a11fc
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ ff56b5ab-992e-47f2-8eb8-00c9c72154c9
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ c85a9184-0d51-4fce-97de-01a03df9f006
dates = sg_data[!, "Date_reported"]

# ╔═╡ 1870aab3-5192-42fe-8924-2f4c5fe78991
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 1877b26a-b7ad-434d-9319-6d68f149f61e
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 385744a9-3459-4011-b391-e9d7c969eede
...
# ╔═╡ 20059bf7-116b-4262-bdb0-814b57af09b0
@bind slider_value Slider(0:10:1000)

# ╔═╡ 5004bf47-3fd4-4583-a286-beecd11acbf1
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ eacf29d8-ef21-402d-adf4-18cafe7911de
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 45aac349-61ce-42d5-bd25-48563a6f4135
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ d928570c-fbd0-4650-9d8f-6897aba0d653
